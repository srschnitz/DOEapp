...
***I had a thought, after using a app to measurement color scales, why couldn't I have an app for simple DOE**
BACKSTORY (building on the above thought, and not the old joke, "you know what a thought did once?"
After a few interviews, trying to get my chemistry jive back, I realized that some companies are way behind with their usaged of DOEs.
Actually, I was really surprised, because it wasn't a new thing, way back when I was a bench chemist.  I know it was my number one goto in my tool belt while working  in R&D /quality after I got my MS in statistics. I was a like a kid with a new toy and I know I annoyed my co-workers with how many I was spitting out.   
***GOALS***
I want both the creation of my experiment and runs and the final analysis.  
I want it to be a simple way to create and run the DOE without needed the expensive software, or creating and running your own coding script.
